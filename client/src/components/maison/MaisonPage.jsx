...
export const MaisonPage = ({
  ...
  const edit = async (imageId, add) => {
    ...
    try {
      const response = await axios.post(mainUrl + "/maison/edit", formData, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "debut " + localStorage.getItem("accessToken"),
        },
    ...
    <>
      <div style={{ marginTop: 100 }}>
            ...
            <>
              {maison.images.map((item, key) => (
                <div
                  ...
                  style={{ maxWidth: "24%", minWidth: 200 }}
                >
                  <img
                    src={mainUrl + `/uploads/${item.path}`}
                    alt=""
                    style={{ width: "100%" }}
                  />
                  {user ? (
        ...
        {user ? (
          <>
            {user._id == maison.proprioId ? (
              ...
              >
                <button
                  className="btn btn-floating modal-trigger waves-effect"
                  href="#modal1"
                >
        ...
        >
          <div>
            ...
            >
              {maison.piscine && (
                <div className="card col black-text " style={{ margin: 1 }}>
                  <div>
                    <i class="fas fa-swimming-pool medium"></i>
                  </div>
                  <h5>Piscine</h5>
                </div>
              )}
              {maison.terrasse && (
                <div className="card col black-text " style={{ margin: 1 }}>
                  <div>
                    <i className=" material-icons medium">balcony</i>
                  </div>
                  <h5>Terrasse</h5>
                </div>
              )}
              {maison.annexe && (
                <div className="card col black-text " style={{ margin: 1 }}>
                  <div>
                    <i className=" material-icons medium">other_houses</i>
                  </div>
                  <h5>Annexe</h5>
                </div>
              )}
              {maison.wifi && (
                <div className="card col black-text " style={{ margin: 1 }}>
                  <div>
                    <i className=" material-icons medium">wifi</i>
                  </div>
                  <h5>Wifi</h5>
                </div>
              )}
              {maison.jardin && (
                <div className="card col black-text " style={{ margin: 1 }}>
                  <div>
                    <i className=" material-icons medium">yard</i>
                  </div>
                  <h5>Jardin</h5>
                </div>
              )}
        ...
        <div>
          <div className="row" style={{ maxWidth: "90%" }}>
            <div className="col s12 m6 center-align">
              ...
              <div
                className="row"
                style={{ maxWidth: "99.9%", marginTop: -15 }}
              >
                <div className="left-align collection">
                  ...
                  <div
                    className="row collection-item valign-wrapper"
                    style={{ maxWeight: 40 }}
                  >
                    <h6>{maison.region}</h6>
                  </div>
                  ...
                  {user._id == maison.proprioId ? (
                    <>
                      ...
                      <div style={{ maxWidth: "99.9%" }}>
                        {maison.enAttente ? (
                          <div
                            className="teal center"
                            style={{ width: 150, padding: 1, borderRadius: 10 }}
                          >
                          ...
                          <div
                            className="teal center"
                            style={{ width: 130, padding: 1, borderRadius: 10 }}
                          >
                            Deja en Locataion
                          </div>
                        ) : (
                          <>
                            ...
                            <button
                              onClick={deleteMaison}
                              className="red btn-floating"
                              style={{ marginTop: 20 }}
                            >
                    ...
                    <>
                      {!user.location ? (
                        ...
                        <>
                          <h5 style={{ maxWidth: "99%" }}>
                            Vous avez deja une location en cours
                          </h5>
      ...
      <div id="modal1" className="modal">
        <div class="modal-content">
          ...
          >
            ...
            >
              ...
              <Button className="btn" style={{ margin: 3 }}>
                Click upload
              </Button>
            </div>
          </Upload.Dragger>
        ...
        <div class="modal-footer">
          <button
            onClick={() => edit(null, true)}
            class="modal-close waves-effect waves-green btn-flat teal"
          >
            Ajouter Photo(s)
          </button>
        </div>
